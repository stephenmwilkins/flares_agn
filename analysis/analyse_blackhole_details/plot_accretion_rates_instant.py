...
with h5py.File('data/accretion_rates_instant.h5', 'r') as hf:
    ...
    for timescale in timescales:
        ...
        print(timescale, np.sum(accretion_rates[timescale][s]))
        ...
        if make_individual_plot:
            ...
            fig.savefig(f'figs/accretion_rates_instant_{timescale}.pdf')
            fig.clf()
...
if make_combined_plot:
    ...
    fig2.savefig(f'figs/accretion_rates_instant_combined.pdf')
    fig2.clf()