...
for i, tag in enumerate(np.flip(fl.tags)):
    ...
    if z == 6.0:
        for jj in range(len(literature['Harikane+2021']['Galaxy+AGN']['z6']['M'])):
            ...
            err = [np.log10(literature['Harikane+2021']['Galaxy+AGN']['z6']['phi_lo'][jj]),
                   np.log10(literature['Harikane+2021']['Galaxy+AGN']['z6']['phi_hi'][jj])]
            axes.flatten()[i].plot(M_, err, lw=1, ls='-', c='black', alpha=0.8)
    ...
    if z == 7.0:
        ...
        for jj in range(len(literature['Harikane+2021']['Galaxy+AGN']['z7']['M'])):
            M_ = [literature['Harikane+2021']['Galaxy+AGN']['z7']['M'][jj], literature['Harikane+2021']['Galaxy+AGN']['z7']['M'][jj]]
            err = [np.log10(literature['Harikane+2021']['Galaxy+AGN']['z7']['phi_lo'][jj]),
                   np.log10(literature['Harikane+2021']['Galaxy+AGN']['z7']['phi_hi'][jj])]
            axes.flatten()[i].plot(M_, err, lw=1, ls='-', c='black', alpha=0.8)
