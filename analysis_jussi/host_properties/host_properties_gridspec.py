...
fig = plt.figure(figsize=(12, 4), constrained_layout=False, linewidth=0)

outer = fig.add_gridspec(1, 3, width_ratios=[4, 4, 4], height_ratios=[2])
gs1 = gsc.GridSpecFromSubplotSpec(2,2, subplot_spec=outer[0, 0], wspace=0, hspace=0)
gs2 = gsc.GridSpecFromSubplotSpec(2,2, subplot_spec=outer[0, 1], wspace=0, hspace=0)
gs3 = gsc.GridSpecFromSubplotSpec(2,2, subplot_spec=outer[0, 2], wspace=0, hspace=0)
...
fig.text(0.24, 0.9, r'$\rm z={0:.0f}$'.format(zeds[0]), fontsize=10, color=cmap(norm(zeds[0])), ha='center')
fig.text(0.513, 0.9, r'$\rm z={0:.0f}$'.format(zeds[1]), fontsize=10, color=cmap(norm(zeds[1])), ha='center')
fig.text(0.786, 0.9, r'$\rm z={0:.0f}$'.format(zeds[2]), fontsize=10, color=cmap(norm(zeds[2])), ha='center')
...
fig.savefig(f'figures/host_gridspec.pdf', bbox_inches='tight')
