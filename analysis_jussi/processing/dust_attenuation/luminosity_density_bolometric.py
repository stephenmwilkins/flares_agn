...
ax1.plot(np.flip(fl.zeds), np.log10(density["gal"]["bolometric"]), 'k-', label=fr"Stellar")
#ax1.plot(np.flip(fl.zeds), np.log10(density["gal"]["uv_attenuated"]), 'k-.', label=fr"Stellar, dusty")
ax1.plot(np.flip(fl.zeds), np.log10(density["agn"]["bolometric"]), 'k--', label=fr"AGN")
...
plt.savefig('figures/lum_density_bolometric.pdf', bbox_inches='tight')
